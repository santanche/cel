function updateHeader() {
	...
	var mainContext = parentWindow.getElementById("main_context").getAttribute("content");
    ...
    if (navigatorPrevious != null) {
        ...
        navigatorBackward.innerHTML = "<a href='" + mainContext + navigatorPrevious.getAttribute("content") +
    ...
    if (navigatorNext != null) {
        ...
        navigatorForward.innerHTML = "<a href='" + mainContext + navigatorNext.getAttribute("content") +
